...
if [ $completed -eq 0 ]; then
    run mirtk recon-neonatal-cortex -v --threads=$threads --config="$surface_recon_config" --sessions="$subj" --prefix="$outvtk/$subj" --temp="$outvtk/temp-recon/$subj" --debug --white --pial --verbose 
